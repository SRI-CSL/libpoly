 ...
 */
void upolynomial_dense_evaluate_at_rational(const upolynomial_dense_t* p_d, const rational_t* x,
    rational_t* value);
...
void upolynomial_dense_evaluate_at_dyadic_rational(const upolynomial_dense_t* p_d,
    const dyadic_rational_t* x, dyadic_rational_t* value);
 ...
 * p_d += p*c
 */
void upolynomial_dense_add_mult_p_c(upolynomial_dense_t* p_d, const upolynomial_t* p,
    const integer_t* c);
 ...
 * p_d += p*m
 */
void upolynomial_dense_add_mult_p_mon(upolynomial_dense_t* p_d, const upolynomial_t* p,
    const umonomial_t* m);

/**
 * p_d -= p*m
 */
void upolynomial_dense_sub_mult_p_mon(upolynomial_dense_t* p_d, const upolynomial_t* p,
    const umonomial_t* m);

/**
 * p_d -= p*m
 */
void upolynomial_dense_sub_mult_mon(upolynomial_dense_t* p_d, int_ring K,
 ...
 * p_d -= p*q
 */
void upolynomial_dense_sub_mult(upolynomial_dense_t* p_d, int_ring K,
 ...
 */
void upolynomial_dense_div_general(int_ring K, int exact, const upolynomial_dense_t* p,
...
void upolynomial_dense_reduce_Z(const upolynomial_dense_t* p_d, const upolynomial_dense_t* q_d,
    integer_t* a, upolynomial_dense_t* red_d);

/**
 * Derivative.
 */
void upolynomial_dense_derivative(int_ring K, const upolynomial_dense_t* p_d,
